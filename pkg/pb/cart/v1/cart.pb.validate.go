...
// Validate checks the field values on UpdateItemQtyRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *UpdateItemQtyRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on UpdateItemQtyRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// UpdateItemQtyRequestMultiError, or nil if none found.
func (m *UpdateItemQtyRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *UpdateItemQtyRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return UpdateItemQtyRequestMultiError(errors)
	}

	return nil
}

// UpdateItemQtyRequestMultiError is an error wrapping multiple validation
// errors returned by UpdateItemQtyRequest.ValidateAll() if the designated
// constraints aren't met.
type UpdateItemQtyRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m UpdateItemQtyRequestMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m UpdateItemQtyRequestMultiError) AllErrors() []error { return m }

// UpdateItemQtyRequestValidationError is the validation error returned by
// UpdateItemQtyRequest.Validate if the designated constraints aren't met.
type UpdateItemQtyRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e UpdateItemQtyRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e UpdateItemQtyRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e UpdateItemQtyRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e UpdateItemQtyRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e UpdateItemQtyRequestValidationError) ErrorName() string {
	return "UpdateItemQtyRequestValidationError"
}

// Error satisfies the builtin error interface
func (e UpdateItemQtyRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sUpdateItemQtyRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = UpdateItemQtyRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = UpdateItemQtyRequestValidationError{}

// Validate checks the field values on UpdateItemQtyResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *UpdateItemQtyResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on UpdateItemQtyResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// UpdateItemQtyResponseMultiError, or nil if none found.
func (m *UpdateItemQtyResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *UpdateItemQtyResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, UpdateItemQtyResponseValidationError{
					field:  "Cart",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return UpdateItemQtyResponseValidationError{
				field:  "Cart",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return UpdateItemQtyResponseMultiError(errors)
	}

	return nil
}

// UpdateItemQtyResponseMultiError is an error wrapping multiple validation
// errors returned by UpdateItemQtyResponse.ValidateAll() if the designated
// constraints aren't met.
type UpdateItemQtyResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m UpdateItemQtyResponseMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m UpdateItemQtyResponseMultiError) AllErrors() []error { return m }

// UpdateItemQtyResponseValidationError is the validation error returned by
// UpdateItemQtyResponse.Validate if the designated constraints aren't met.
type UpdateItemQtyResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e UpdateItemQtyResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e UpdateItemQtyResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e UpdateItemQtyResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e UpdateItemQtyResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e UpdateItemQtyResponseValidationError) ErrorName() string {
	return "UpdateItemQtyResponseValidationError"
}

// Error satisfies the builtin error interface
func (e UpdateItemQtyResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sUpdateItemQtyResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = UpdateItemQtyResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = UpdateItemQtyResponseValidationError{}
